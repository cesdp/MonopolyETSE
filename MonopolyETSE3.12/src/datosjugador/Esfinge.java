...
public class Esfinge extends Avatar {
    ...
    public Esfinge(Jugador nombreJugador, Tablero partida) {
    ...
    public void moverEnAvanzado(int n) {
        ...
        if (n > 4) {
            ...
            if ((this.getTablero().PosicionCasilla(this.getUbicacion()) <= 39 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 30) || (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 9 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 0)) {
                for (int i = 0; i < n; i++) {
                    if (this.getRepeticiones() <= 3) {
                        ...
                        if (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 39 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 30) {
                            ...
                            if (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 9 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 0) {
                                pos = (29 - this.getTablero().PosicionCasilla(this.getUbicacion()));
                                if (this.getTablero().PosicionCasilla(this.getUbicacion()) == 9) {
                                    pos = 30;

                                }
                            }
                            if (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 29 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 21) {
                                pos = (11 - (this.getTablero().PosicionCasilla(this.getUbicacion()) - 20));
                                if (this.getTablero().PosicionCasilla(this.getUbicacion()) == 21) {
                                    pos = 0;
            ...
            } else if ((this.getTablero().PosicionCasilla(this.getUbicacion()) <= 29 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 10)) {
                for (int i = 0; i < n; i++) {
                    if (this.getRepeticiones() <= 3) {
                        ...
                        if (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 19 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 10) {
                            ...
                            if (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 9 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 0) {
                                pos = (31 - this.getTablero().PosicionCasilla(this.getUbicacion()));
                                if (this.getTablero().PosicionCasilla(this.getUbicacion()) == 1) {
                                    pos = 20;

                                }
                            }
                            if (this.getTablero().PosicionCasilla(this.getUbicacion()) <= 29 && this.getTablero().PosicionCasilla(this.getUbicacion()) >= 21) {
                                pos = (9 - (this.getTablero().PosicionCasilla(this.getUbicacion()) - 20));
                                if (this.getTablero().PosicionCasilla(this.getUbicacion()) == 29) {
                                    pos = 10;
